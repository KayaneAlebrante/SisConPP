...
async function main() {
    ...
    await prisma.blocoProva.createMany({
        data: [
            ...
            { idBloco: 1, nomeBloco: "Prova Oral", notaMaximaBloco: 65, provaPraticaId: 1 },
            { idBloco: 2, nomeBloco: "Prova Artística", notaMaximaBloco: 18, provaPraticaId: 1 },

            //Prova Pratica Peão Mirim
            { idBloco: 3, nomeBloco: "Prova Oral", notaMaximaBloco: 65, provaPraticaId: 2 },
            { idBloco: 4, nomeBloco: "Prova Artística", notaMaximaBloco: 18, provaPraticaId: 2 },
            { idBloco: 5, nomeBloco: "Prova Campeira", notaMaximaBloco: 17, provaPraticaId: 2 },

            //Prova Pratica Prenda Juvenil, Adulta, Veterana e Xirua
            { idBloco: 6, nomeBloco: "Prova Oral", notaMaximaBloco: 63, provaPraticaId: 3 },
            { idBloco: 7, nomeBloco: "Prova Artística", notaMaximaBloco: 25, provaPraticaId: 3 },
            { idBloco: 8, nomeBloco: "Prova Dotes", notaMaximaBloco: 12, provaPraticaId: 3 },

            //Prova Pratica Peão Juvenil, Adulto, Veterano e Xiru
            { idBloco: 9, nomeBloco: "Prova Oral", notaMaximaBloco: 62, provaPraticaId: 4 },
            { idBloco: 10, nomeBloco: "Prova Artística", notaMaximaBloco: 19, provaPraticaId: 4 },
            { idBloco: 11, nomeBloco: "Prova Campeira", notaMaximaBloco: 19, provaPraticaId: 4 }
        ]
    });
    ...
    await prisma.quesitos.createMany({
        data: [
            ...
            { idQuesito: 1, nomeQuesito: "Vivência Tradicionalista Gaúcha", notaMaximaQuesito: 33, opcional: false, blocoProvaIdBloco: 1 },
            { idQuesito: 2, nomeQuesito: "Projeto Principal - Executado na Atual Gestão", notaMaximaQuesito: 10, opcional: false, blocoProvaIdBloco: 1 },
            { idQuesito: 3, nomeQuesito: "Outros Projetos e Ações Executados", notaMaximaQuesito: 5, opcional: false, blocoProvaIdBloco: 1 },
            { idQuesito: 4, nomeQuesito: "Comunicação Oral", notaMaximaQuesito: 12, opcional: false, blocoProvaIdBloco: 1 },
            { idQuesito: 5, nomeQuesito: "Desenvoltura e Expressão", notaMaximaQuesito: 5, opcional: false, blocoProvaIdBloco: 1 },
            { idQuesito: 6, nomeQuesito: "Indumentária", notaMaximaQuesito: -5, opcional: false, blocoProvaIdBloco: 1 },

            //Prova Artística Prenda Mirim
            { idQuesito: 7, nomeQuesito: "Dança Gaúcha de Salão", notaMaximaQuesito: 5, opcional: false, blocoProvaIdBloco: 2 },
            { idQuesito: 8, nomeQuesito: "Artesanato", notaMaximaQuesito: 6, opcional: false, blocoProvaIdBloco: 2 },
            { idQuesito: 9, nomeQuesito: "Declamação", notaMaximaQuesito: 6, opcional: true, blocoProvaIdBloco: 2 },
            { idQuesito: 10, nomeQuesito: "Intérprete Vocal/Cantar", notaMaximaQuesito: 6, opcional: true, blocoProvaIdBloco: 2 },
            { idQuesito: 11, nomeQuesito: "Execução Instrumental", notaMaximaQuesito: 6, opcional: true, blocoProvaIdBloco: 2 },
            { idQuesito: 12, nomeQuesito: "Dança Folclórica Tradicional", notaMaximaQuesito: 5, opcional: true, blocoProvaIdBloco: 2 },
            { idQuesito: 13, nomeQuesito: "Contar uma Lenda", notaMaximaQuesito: 6, opcional: true, blocoProvaIdBloco: 2 },
            { idQuesito: 14, nomeQuesito: "Contar Causo", notaMaximaQuesito: 6, opcional: true, blocoProvaIdBloco: 2 },
            { idQuesito: 15, nomeQuesito: "Prova Campeira Regulamentada", notaMaximaQuesito: 6, opcional: true, blocoProvaIdBloco: 2 },
            { idQuesito: 16, nomeQuesito: "Encilhar", notaMaximaQuesito: 6, opcional: true, blocoProvaIdBloco: 2 },
            { idQuesito: 17, nomeQuesito: "Desenvolura e expressão", notaMaximaQuesito: 2, opcional: false, blocoProvaIdBloco: 2 },

            //Prova Oral Peão Mirim 
            { idQuesito: 1, nomeQuesito: "Vivência Tradicionalista Gaúcha", notaMaximaQuesito: 33, opcional: false, blocoProvaIdBloco: 3 },
            { idQuesito: 2, nomeQuesito: "Projeto Principal - Executado na Atual Gestão", notaMaximaQuesito: 10, opcional: false, blocoProvaIdBloco: 3 },
            { idQuesito: 3, nomeQuesito: "Outros Projetos e Ações Executados", notaMaximaQuesito: 5, opcional: false, blocoProvaIdBloco: 3 },
            { idQuesito: 4, nomeQuesito: "Comunicação Oral", notaMaximaQuesito: 12, opcional: false, blocoProvaIdBloco: 3 },
            { idQuesito: 5, nomeQuesito: "Desenvoltura e Expressão", notaMaximaQuesito: 5, opcional: false, blocoProvaIdBloco: 3 },
            { idQuesito: 6, nomeQuesito: "Indumentária", notaMaximaQuesito: -5, opcional: false, blocoProvaIdBloco: 3 },
