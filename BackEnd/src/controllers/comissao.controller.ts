...
class ComissaoController {
    ...
    async adicionarAvaliadorComissao(req: Request, res: Response) {
        ...
        try {
            const comissaoUsuario = await comissaoService.adicionarUsuarioComissao(usuarioId, comissaoId);
    ...
    async adicionarAuxiliarComissao(req: Request, res: Response) {
        ...
        try {
            const comissaoUsuario = await comissaoService.adicionarAuxiliarComissao(usuarioId, comissaoId);
            return res.status(201).json(comissaoUsuario);
        } catch (error: any) {
            return res.status(500).json({ error: error.message });
        }
    ...
    async deletarUsuarioComissao(req: Request, res: Response) {
        ...
        try {
            await comissaoService.deletarUsuarioComissao(Number(usuarioId), Number(comissaoId));
    ...
    async listarUsuariosComissao(req: Request, res: Response) {
        try {
            const usuarios = await comissaoService.listComissaoUsuarios();
