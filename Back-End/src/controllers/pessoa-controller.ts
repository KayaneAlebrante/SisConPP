...
class PessoaController{
    async criarPessoa(req: Request, res: Response){
        ...
        try{
            const pessoa = await PessoaService.criarPessoa(nomeCompleto, cidade, estado, numCarteirinha);
    ...
    async atualizarPessoa(req: Request, res: Response){
        ...
        try{
            const pessoa = await PessoaService.atualizarPessoa(Number(id), data);
    ...
    async buscarPessoaPorId(req: Request, res: Response){
        ...
        try{
            const pessoa = await PessoaService.buscarPessoaPorId(Number(id));
            if(!pessoa){
    ...
    async buscarPessoas(req: Request, res: Response){
        try{
            const pessoas = await PessoaService.buscarPessoas();
    ...
    async deletarPessoa(req: Request, res: Response){
        ...
        try{
            await PessoaService.deletarPessoa(Number(id));
